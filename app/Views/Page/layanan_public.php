    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <h5 class="card-title fw-semibold mb-4">Layanan Public</h5>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?= base_url('uploads/layanan_public/'.$r['pdf']) ?>"
                     target="_blank"
                ...
                <td>
                  ...
                  <a href="<?= base_url('layanan-public/delete/'.$r['layanan_id']) ?>"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title fw-semibold">Add Layanan</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <form action="<?= base_url('layanan-public/add') ?>" 
            method="post" 
...
editModal.addEventListener('show.bs.modal', function (event) {
  ...
  document.getElementById('editForm').action =
    "<?= base_url('layanan-public/update/') ?>" + btn.dataset.id;
});
</script>
