    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-body">
          ...
          <h5 class="card-title fw-semibold mb-4">PERKIN</h5>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?= base_url('uploads/perkin/'.$r['pdf']) ?>"
                     target="_blank"
                ...
                <td>
                  ...
                  <a href="<?= base_url('perkin/delete/'.$r['perkin_id']) ?>"
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title fw-semibold">Add Perkin</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <form action="<?= base_url('perkin/add') ?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="editModal" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title fw-semibold">Edit Perkin</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
editModal.addEventListener('show.bs.modal', function (event) {
  ...
  document.getElementById('editForm').action =
    "<?= base_url('perkin/update/') ?>" + btn.dataset.id;
});
</script>
