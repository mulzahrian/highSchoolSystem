  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        ...
        <h5 class="card-title fw-semibold mb-4">KOM</h5>
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <?php if (!empty($ktsps)): ?>
              <?php foreach ($ktsps as $row): ?>
                <tr>
                  <td>
                    <img src="<?= base_url('uploads/ktsp/' . $row['image']) ?>"
                  ...
                  <td>
                    <a href="<?= base_url('ktsp/delete/' . $row['ktsp_id']) ?>"
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title fw-semibold">Add KTSP</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <form action="<?= base_url('ktsp/add') ?>" method="post" enctype="multipart/form-data">
