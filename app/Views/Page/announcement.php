                ...
                <tr>
                  <td>
                    <?php if ($row['thumbnail']): ?>
                      <img src="<?= base_url('uploads/announcement/' . $row['thumbnail']) ?>"
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title fw-semibold">Add Announcement</h5>
      ...
      <form action="<?= base_url('announcement/add') ?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="year" class="form-control" placeholder="ex: Kelulusan Siswa" required>
          </div>
