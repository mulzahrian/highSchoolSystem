...
<div class="body-wrapper-inner">
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">PTMT</h5>
...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      <td><?= esc($r['header']) ?></td>
      <td>
        <a href="<?= base_url('uploads/ptmt/'.$r['pdf']) ?>" target="_blank"
      ...
      <td>
        ...
        <a href="<?= base_url('ptmt/delete/'.$r['ptmt_id']) ?>"
...
<div class="modal fade" id="addModal">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<?= base_url('ptmt/add') ?>" method="post" enctype="multipart/form-data">
  <input type="text" name="header" class="form-control mb-2" placeholder="Header" required>

  <input type="file" name="pdf" class="form-control mb-2" accept="application/pdf" required>
...
editModal.addEventListener('show.bs.modal', function (event) {
  ...
  document.getElementById('editForm').action =
    "<?= base_url('ptmt/update/') ?>" + btn.dataset.id;
});
</script>
