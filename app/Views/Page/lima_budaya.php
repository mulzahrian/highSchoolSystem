    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-body">
          ...
          <h5 class="card-title fw-semibold mb-4">LIMA BUDAYA</h5>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <img src="<?= base_url('uploads/lima-budaya/'.$r['image']) ?>"
                       width="100"
                       class="img-thumbnail">
                </td>
                ...
                <td>
                  ...
                  <a href="<?= base_url('lima-budaya/delete/'.$r['lima_id']) ?>"
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">Add Lima Budaya</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <form action="<?= base_url('lima-budaya/add') ?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="editModal">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title">Edit Lima Budaya</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
editModal.addEventListener('show.bs.modal', function (event) {
  ...
  document.getElementById('editForm').action =
    "<?= base_url('lima-budaya/update/') ?>" + btn.dataset.id;
});
</script>
