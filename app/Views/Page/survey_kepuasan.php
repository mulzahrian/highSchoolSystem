    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <h5 class="card-title fw-semibold mb-4">Survey Kepuasan</h5>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?= base_url('uploads/survey_kepuasan/'.$r['pdf']) ?>"
                     target="_blank"
                ...
                <td>
                  ...
                  <a href="<?= base_url('survey_kepuasan/delete/'.$r['survey_id']) ?>"
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title fw-semibold">Add Mutasi Siswa</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <form action="<?= base_url('survey_kepuasan/add') ?>"
            method="post"
...
<div class="modal fade" id="editModal" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title fw-semibold">Edit Mutasi Siswa</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
editModal.addEventListener('show.bs.modal', function (event) {
  ...
  document.getElementById('editForm').action =
    "<?= base_url('survey_kepuasan/update/') ?>" + btn.dataset.id;
});
</script>