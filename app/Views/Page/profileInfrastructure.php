  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        ...
        <h5 class="card-title fw-semibold mb-4">Infrastructure</h5>

        <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addInfrastructureModal">
          + Add Infrastructure
        </button>
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <?php if (!empty($infrastructures)): ?>
              <?php foreach ($infrastructures as $row): ?>
                <tr>
                  <td>
                    <img src="<?= base_url('uploads/infrastructure/' . $row['image']) ?>"
...
<!-- MODAL ADD -->
<div class="modal fade" id="addInfrastructureModal" tabindex="-1" data-bs-focus="false">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">

      <div class="modal-header">
        <h5 class="modal-title fw-semibold">Add Infrastructure</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <form action="<?= base_url('profile-infrastructure/add') ?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <textarea name="detail" id="historyEditor" class="form-control" rows="6"></textarea>
          </div>
