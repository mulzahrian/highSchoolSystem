        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <img src="<?= base_url('uploads/artikel/'.$r['image']) ?>"
                     width="100"
                     class="img-thumbnail">
              </td>
              ...
              <td>
                ...
                <a href="<?= base_url('artikel/delete/'.$r['artikel_id']) ?>"
...
<div class="modal fade" id="addModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?= base_url('artikel/add') ?>" method="post" enctype="multipart/form-data">
...
editModal.addEventListener('show.bs.modal', function (event) {
  ...
  document.getElementById('editForm').action =
    "<?= base_url('artikel/update/') ?>" + btn.dataset.id;
});
</script>