...
<div class="body-wrapper-inner">
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Zona Integrasi</h5>
...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      <td><?= esc($r['header']) ?></td>
      <td>
        <img src="<?= base_url('uploads/zona_integrasi/'.$r['image']) ?>" width="80">
      </td>
      <td><?= esc($r['content']) ?></td>
      <td>
      ...
      <td>
        ...
        <a href="<?= base_url('zona-integrasi/delete/'.$r['zona_id']) ?>"
...
<div class="modal fade" id="addModal" tabindex="-1" data-bs-focus="false">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    ...
    <form action="<?= base_url('zona-integrasi/add') ?>" method="post" enctype="multipart/form-data">
...
editModal.addEventListener('show.bs.modal', function (event) {
  ...
  document.getElementById('editEditor').value = btn.dataset.content;

  document.getElementById('editForm').action =
    "<?= base_url('zona-integrasi/update/') ?>" + btn.dataset.id;
});
</script>
