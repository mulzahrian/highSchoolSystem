    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <h5 class="card-title fw-semibold mb-4">Mutasi Siswa</h5>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="<?= base_url('uploads/mutasi_siswa/'.$r['pdf']) ?>"
                     target="_blank"
                ...
                <td>
                  ...
                  <a href="<?= base_url('mutasi_siswa/delete/'.$r['mutasi_id']) ?>"
...
<div class="modal fade" id="addModal" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="<?= base_url('mutasi_siswa/add') ?>"
            method="post"
...
editModal.addEventListener('show.bs.modal', function (event) {
  ...
  document.getElementById('editForm').action =
    "<?= base_url('mutasi_siswa/update/') ?>" + btn.dataset.id;
});
</script>