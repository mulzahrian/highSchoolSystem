  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-body">
        ...
        <h5 class="card-title fw-semibold mb-4">Opening</h5>

        <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addOpeningModal">
          + Add Opening
        </button>
            ...
            <?php if (!empty($opening)): ?>
              <?php foreach ($opening as $row): ?>
                <tr>
                  <td>
                    <?php if ($row['image']): ?>
                      <img src="<?= base_url('uploads/opening/' . $row['image']) ?>"
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title fw-semibold">Add Opening</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <form action="<?= base_url('opening/add') ?>" method="post" enctype="multipart/form-data">
