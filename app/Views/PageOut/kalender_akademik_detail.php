...
.kalender-detail-img {
    ...
    <section class="kalender-detail">
  <div class="container">

    <div class="kalender-detail-box">

      <div class="kalender-detail-year">
        Kalender Akademik <?= esc($kalender['year']) ?>
      </div>

      <?php if (!empty($kalender['image'])): ?>
        <img
          src="<?= base_url('uploads/academic-calender/' . $kalender['image']) ?>"
          class="kalender-detail-img"
          alt="Kalender <?= esc($kalender['year']) ?>">
      <?php endif ?>
