...
<section class="pengumuman-detail">
  <div class="container">
    ...
    <div class="pengumuman-detail-box">

      <div class="pengumuman-detail-year">
        Pengumuman <?= esc($pengumuman['year']) ?>
      </div>

      <?php if (!empty($pengumuman['thumbnail'])): ?>
        <img
          src="<?= base_url('uploads/announcement/' . $pengumuman['thumbnail']) ?>"
          class="pengumuman-detail-img"
          alt="Pengumuman <?= esc($pengumuman['year']) ?>">
      <?php endif ?>
